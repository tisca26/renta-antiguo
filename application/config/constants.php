 ...
 * Elementos Icognitis
 */
defined('ICOGNITIS')                OR define('ICOGNITIS','Icognitis');
defined('ICOGNITIS_SACV')           OR define('ICOGNITIS_SACV',ICOGNITIS.' S.A de C.V.');
defined('ICOGNITIS_URL')            OR define('ICOGNITIS_URL','http://www.icognitis.com');
?>
